! function(t) {
	...
	! function() {
		...
		function i(t, e, i) {
			...
			var o = t.style;
			n && (o.cssText += ";" + n), n = e;
			for (var s in n) o["float" === s || "cssFloat" === s ? "undefined" == typeof o.styleFloat ? "cssFloat" : "styleFloat" : s] = n[s]
		}
		...
		function a(t) {
			...
			if (t && (a = t.getAttribute("data-href")) && c(a) && !l) {
				var d = parseInt(t.getAttribute("data-width"), 1) || p;
				h.width = d, h.language = t.getAttribute("data-language") || "en_US", h.did = t.getAttribute("data-did") || null;
				var u = document.createElement("iframe");
				u.setAttribute("title", "Tumblr post"), u.setAttribute("frameborder", 0), u.setAttribute("allowfullscreen", !0), u.src = r(a, h), e(u, "tumblr-embed"), i(u, {
					display: "block",
					padding: "0",
					margin: "10px 0",
					border: "none",
		...
		function h() {
			for (var t = document.querySelectorAll(".tumblr-post"), e = 0, i = t.length; e < i; e++) a(t[e])
		}
		var l = !window.addEventListener;
		! function() {
			var t = window.tumblr || {};
			t.embed = t.embed || {}, o(function() {
				h()
			})
		}()
	}()
	...
	function o() {
		var t = new w;
		return t.cid = m, m += 1, v[t.cid] = t, t
	}

	function s(t, e) {
		for (var i, n = g.length - 1; n >= 0; n--) g[n].message_callback(t, e);
		for (n = y.length - 1; n >= 0; n--) i = y[n], i && i.shouldRespond && i.shouldRespond(t, e) && i.cb(t, e)
	}

	function r(t) {
		if (t || (t = {}), !(l && l.stringify && l.parse)) throw "Must have JSON parsing and stringify";
		...
		}, this._on_connected = new f, this._unanswered_calls = {}, this.on_connection(d(this.enable_sending_post_message, this)), g.push(this), t.window && this.setWindow(t.window)
	}
	...
	var _ = function(t) {
		if (t.cid_response && t.cid_response in v) {
			...
			e.resolve.call(null, this, t.response), delete v[t.cid_response]
		}
	};
	r.prototype.setWindow = function(t) {
		...
		if ((!this.window || t.source === this.window) && this.match_origin(t.origin)) {
			if (e.method && e.method.slice(0, this.namespace.length) === this.namespace && (i = e.method.slice(this.namespace.length, e.method.length)), e.args && n(e.args)) try {
		...
		if (t) {
			...
			n = o.apply(e, i.args), i.cid && "_method_callback_responder" !== t && this.send_to_window(e.source, "_method_callback_responder", {
				cid_response: i.cid,
				response: n
			})
		}
		...
		var i = this,
			t = function() {
				...
				return t.unshift(e), i.send.apply(i, t)
			};
		return t
		...
		if (this.send_post_message = c, this._delayed_sent_messages) {
			for (var t = 0; t < this._delayed_sent_messages.length; t += 1) c.apply(this, this._delayed_sent_messages[t]);
		...
		if (n(t)) {
			...
			if (i && (e = d(e, i)), this.responders[t] = e, this._unanswered_calls[t]) {
				...
				for (var r = 0; r < s.length; r += 1) o = s[r], this.call_responder.apply(this, o)
			}
		} else {
			var c = t;
			for (t in c) c.hasOwnProperty(t) && this.listen_to(t, c[t], i)
		}
	...
	function i(t, e) {
		...
		if (!e || !e(i)) {
			...
			document.body.appendChild(o), i = o.contentWindow[t], document.body.removeChild(o)
		}
		return n[t] = i, i
	}
	var n = {};
	...
	i.prototype = {
		...
		if (this.triggered_with)
			for (var t = 1 <= arguments.length ? n.call(arguments, 0) : [], e = 0; e < t.length; e += 1) t[e].apply(null, this.triggered_with);
		return o.apply(this, arguments)
	}, i.prototype.trigger = function() {
		var t = 1 <= arguments.length ? n.call(arguments, 0) : [],
			e = this.length;
		this.triggered_with = t;
		for (var i = 0; i < e; i += 1) this[i].apply(null, this.triggered_with);
		return this
	}, t.exports = i
}, function(t, e, i) {
	"use strict";
	...
	function n() {
		this._on_resolved = new r, this._on_rejected = new r, this.then = s(this.then, this), this.fail = s(this.fail, this), this.resolve = s(this.resolve, this), this.reject = s(this.reject, this)
	}
	var o = [].slice,
		s = function(t, e) {
			return function() {
	...
	function i(t) {
		function e() {
			s.removeEventListener("DOMContentLoaded", e), t()
		}
		s.addEventListener("DOMContentLoaded", e)
	}

	function n(t) {
		o || (o = /^loaded|^i|^c/.test(s.readyState)), o ? setTimeout(t) : i(t)
	}
	var o, s = document;
	t.exports = n
}, function(t, e, i) {
		...
		return function(t) {
			...
			var c = i(1),
				...
				d = function() {
					function t(e, i) {
						function c() {
							if (h.viewportTop = r(e), h.viewportBottom = h.viewportTop + h.viewportHeight, h.documentHeight = s(e), h.documentHeight !== p) {
						...
						function a() {
							for (u = h.watchers.length; u--;) h.watchers[u].update();
							for (u = h.watchers.length; u--;) h.watchers[u].triggerCallbacks()
						}
						n(this, t);
						var h = this;
			...
			function n(t, e, i) {
				function n(t, e) {
					if (0 !== t.length)
						for (_ = t.length; _--;) b = t[_], b.callback.call(o, e, o), b.isOne && t.splice(_, 1)
				}
				var o = this;
				...
				for (var f = 0, w = d.length; f < w; f++) o.callbacks[d[f]] = [];
				this.locked = !1;
				var m, v, g, y, _, b;
				this.triggerCallbacks = function(t) {
					switch (this.isInViewport && !m && n(this.callbacks[r], t), this.isFullyInViewport && !v && n(this.callbacks[c], t), this.isAboveViewport !== g && this.isBelowViewport !== y && (n(this.callbacks[s], t), v || this.isFullyInViewport || (n(this.callbacks[c], t), n(this.callbacks[h], t)), m || this.isInViewport || (n(this.callbacks[r], t), n(this.callbacks[a], t))), !this.isFullyInViewport && v && n(this.callbacks[h], t), !this.isInViewport && m && n(this.callbacks[a], t), this.isInViewport !== m && n(this.callbacks[s], t), !0) {
					...
					m = this.isInViewport, v = this.isFullyInViewport, g = this.isAboveViewport, y = this.isBelowViewport
					...
					if (!this.locked) {
						...
						this.top -= this.offsets.top, this.bottom += this.offsets.bottom, this.height = this.bottom - this.top, void 0 === t && void 0 === e || this.top === t && this.bottom === e || n(this.callbacks[l], null)
					}
				}, this.recalculateLocation(), this.update(), m = this.isInViewport, v = this.isFullyInViewport, g = this.isAboveViewport, y = this.isBelowViewport
			}
			var o = i(1),
